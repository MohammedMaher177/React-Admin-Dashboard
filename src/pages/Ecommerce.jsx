  ...
  return (
    <div className="mt-24">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className=" border-r-1 border-color m-4 pr-10">
              ...
              <div className="mt-8">
                <p className="text-3xl font-semibold">$48,487
                  <span className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-red-900 ml-3 text-xs">
                    87%
                  </span>
                </p>
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          <div className="flex justify-between">
            <p className="text-xl font-semibold">Project Credits!!</p>
            <button
              type="button"
              className="text-xl font-semibold text-gray-500"
            >
          ...
          <div className="mt-10">
            ...
            <div className="mt-8">
              ...
              <p className="text-gray-400 ">By Om Patel</p>
              ...
              <div className="mt-3 flex flex-col space-y-2">
                <a href="https://github.com/omunite215">
                  <Button
                    color="white"
                    bgColor={currentColor}
                    text="Om's Github Repository"
                    borderRadius="10px"
                  />
                </a>
                <a href="https://youtu.be/jx5hdo50a2M">
                  <Button
                    color="white"
                    bgColor={currentColor}
